...
train_data_dir = 'D:/施雨欣/深度学习/Test/mix_t_ad/'  # 训练集数据目录路径
val_data_dir = 'D:/施雨欣/深度学习/Test/mix_v_ad/'  # 验证集数据目录路径
img_height = img_width = img_depth = 128  # 图像尺寸

# adam = Adam(lr=0.08423, epsilon=1.0)
adam = Adam(lr=0.0001, epsilon=1e-08)
sgd = SGD(lr=0.0001)
adadelta = Adadelta(lr= 0.08423,epsilon= 1.0,rho=0.625)
