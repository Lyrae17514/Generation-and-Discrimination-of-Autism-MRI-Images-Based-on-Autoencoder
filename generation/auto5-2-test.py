...
def svae_image(generator,num):
    ...
    nib.save(new_image, r'D:/施雨欣/深度学习/Results/HCP/4000_128_5/' + strtime + '.nii.gz')
...
encoded = Dense(units=5, activation='relu', )(input_img)
...
decoded = Dense(units=5, activation='relu')(decoded)
