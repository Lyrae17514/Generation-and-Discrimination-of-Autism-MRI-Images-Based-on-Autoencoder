...
# path_G='D:/施雨欣/深度学习/帕金森/T11/patient/'
...
def randchoose():
    while 1:
        ...
        # cc = T1_file_name[random.randint(0, 34)]
        # cc = T1_file_name[0]
        print(cc)
...
def svae_image(generator,num):
    ...
    nib.save(new_image, r'D:/施雨欣/深度学习/Results/Max/autoencoder_nii/con_200/' + strtime + '.nii.gz')
...
decoded = Dense(units=8000000, activation='tanh')(decoded)
